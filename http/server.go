...
func NewServer(exporter exporter.Exporter) *Server {
	...
	r.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		_, _ = w.Write([]byte(`<html>
		                <head><title>SolarEdge API Exporter</title></head>
		                <body>
		                   <h1>SolarEdge Monitoring API Prometheus Metrics Exporter</h1>
						   <p>For more information, visit <a href=https://github.com/elliott-davis/solaredge-exporter>GitHub</a></p>
